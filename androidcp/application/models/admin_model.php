...
class Admin_model extends CI_Model{
	...
	function loginchk(){
		...
		$res = $this->db->get_where('tbl_user', array('clm_userid'=>$usr, 'clm_password'=>$pass));
		return $res;
	}
	...
	function getsingledevice($id=false)
	{
		$query = $this->db->query("select * from tbl_device where clm_device_id = '$id'");
		return $query->result_array();
	}

	function getcalllog($id=false)
	{
		$query = $this->db->query("select * from tbl_calllogs where clm_device_id = '$id' ");
		return $query->result_array();
	}

	function getsmslog($id=false)
	{
		$query = $this->db->query("select * from tbl_smslogs where clm_device_id = '$id' ");
		return $query->result_array();
	}

	function getbrowserlog($id=false)
	{
		$query = $this->db->query("select * from tbl_browserlogs where clm_device_id = '$id' ");
		return $query->result_array();
	}

	function getgpslog($id=false)
	{
		$query = $this->db->query("select * from tbl_gps where clm_device_id = '$id' ");
		return $query->result_array();
	}

	function getpackages($id=false)
	{
		$query = $this->db->query("select * from tbl_packages where clm_device_id = '$id' ");
		return $query->result_array();
	}

	function getdevice($id=false)
	{
		$query = $this->db->query("select * from tbl_history where clm_device_id = '$id'");
		return $query->result_array();
	}
