...
/**
 * Base application class to extend from, solving some issues with toasts and
 * AsyncTasks you are likely to run into
 */
public class Application extends android.app.Application {
	...
	public void onCreate() {
		...
		try {
			// workaround bug in AsyncTask, can show up (for example) when you
			// toast from a service
			// this makes sure AsyncTask's internal handler is created from the
			// right (main) thread
