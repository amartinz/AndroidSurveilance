...
public class CandidateView extends View {
	...
	private int mTouchX = CandidateView.OUT_OF_BOUNDS;
	...
	private int[] mWordWidth = new int[CandidateView.MAX_SUGGESTIONS];
	private int[] mWordX = new int[CandidateView.MAX_SUGGESTIONS];
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		int measuredWidth = View.resolveSize(50, widthMeasureSpec);
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < count; i++) {
			...
			final int wordWidth = (int) textWidth + (CandidateView.X_GAP * 2);
			...
			if (canvas != null) {
				...
				canvas.drawText(suggestion, x + CandidateView.X_GAP, y, paint);
				paint.setColor(mColorOther);
	...
	private void scrollToTarget() {
		...
		if (mTargetScrollX > sx) {
			sx += CandidateView.SCROLL_PIXELS;
	...
	public void clear() {
		mSuggestions = CandidateView.EMPTY_LIST;
		mTouchX = CandidateView.OUT_OF_BOUNDS;
		mSelectedIndex = -1;
		invalidate();
	}
